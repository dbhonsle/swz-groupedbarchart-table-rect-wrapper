...
function (_PureComponent) {
  ...
  function D3ChartwithTableWrapper(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onResize", debounce(function (_ref) {
      ...
      var el = ReactDOM.findDOMNode(_assertThisInitialized(_assertThisInitialized(_this)));
